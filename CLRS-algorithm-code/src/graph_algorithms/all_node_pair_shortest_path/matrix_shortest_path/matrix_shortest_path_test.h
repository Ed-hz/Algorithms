...
/*!
 *
 * `MatrixShortestPathTest`是 `::testing::Test`
 * 的子类。它主要用于为每一个`TEST_F`准备测试环境
 */
class MatrixShortestPathTest : public ::testing::Test {
public:
  typedef Graph<MT_N, Vertex<int>>
      GType; /*!< 模板实例化的图类型，该图的顶点类型为`Vertex<int>`*/
...
TEST_F(MatrixShortestPathTest, test_matrix_shortest_path) {
  typedef std::array<std::array<typename GType::EWeightType, MT_N>, MT_N>
      MatrixType;
  MatrixType real_result = {
      std::array<typename GType::EWeightType, MT_N>({0, 1, -3, 2, -4}),
