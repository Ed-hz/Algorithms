...
TEST_F(FrontFlowVertexTest, test_FrontFlowVertex_member) {
  ...
  EXPECT_EQ(_default_vertex->to_string(),
            "vertex id:-1\t key:0\t h:0\t N_List:list:\n\ncurrent:\tnullptr");
  ...
  EXPECT_EQ(_normal_vertex->to_string(),
            "vertex id:1\t key:21\t h:0\t N_List:list:\n\ncurrent:\tnullptr");
}
//! FrontFlowVertexTest：测试 FrontFlowVertex
/*!
 *
...
TEST_F(FrontFlowVertexTest, test_node) {
  ...
  EXPECT_EQ(_nodes[0]->to_string(), "list_node:vertex id:-1\t key:0\t h:0\t "
                                    "N_List:list:\n\ncurrent:\tnullptr");
}
//! FrontFlowVertexTest：测试 FrontFlowVertex
/*!
...
TEST_F(FrontFlowVertexTest, test_list) {
  ...
  EXPECT_EQ(_list->to_string(),
            "list:\nlist_node:nullptr;\tlist_node:nullptr;\tlist_node:nullptr;"
            "\tlist_node:nullptr;\t\ncurrent:\tnullptr");
