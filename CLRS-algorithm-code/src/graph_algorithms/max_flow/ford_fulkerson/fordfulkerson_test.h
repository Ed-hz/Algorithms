...
TEST_F(FordFulkersonTest, test_ford_fulkerson) {
  typedef std::array<std::array<typename GType::EWeightType, FF_N>, FF_N>
      MatrixType;
  MatrixType real_flow = {
      std::array<typename GType::EWeightType, FF_N>({0, 12, 11, 0, 0, 0}),
