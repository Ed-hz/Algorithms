...
template <typename GraphType,
          typename ActionType = std::function<
              void(typename GraphType::VIDType, typename GraphType::VIDType)>>
typename GraphType::EWeightType kruskal(
  ...
  std::sort(edges.begin(), edges.end(),
            [](const EdgeTupleType &edge1, const EdgeTupleType &edge2) -> bool {
