 ...
 *
 * Dijkstra算法核心信息是一组结点集合 S 。从源结点s 到集合 S
 * 中的每一个结点之间的最短路径已经被找到。算法重复从结点集合 V-S
 * 中选择最短路径估计最小的结点u,
...
void dijkstra(std::shared_ptr<GraphType> graph,
  ...
  if (source_id < 0 || source_id >= GraphType::NUM ||
    ...
    throw std::invalid_argument(
        "dijkstra error: source_id muse belongs [0,N) and "
